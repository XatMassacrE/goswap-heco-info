  ...
  return (
    <DashGrid style={{ height: '48px' }} disbaleLinks={disbaleLinks} focus={true}>
      ...
      <DataText area="name" fontWeight="500">
        ...
        <Link style={{ marginLeft: '20px', whiteSpace: 'nowrap' }} color={color} external href={'https://hecoinfo.com/address/' + item.uToken}>
          <FormattedName
      ...
      <DataText area="name" fontWeight="500">
        ...
        <Link style={{ marginLeft: '20px', whiteSpace: 'nowrap' }} color={color} external href={'https://hecoinfo.com/address/' + item.yToken}>
          <FormattedName
